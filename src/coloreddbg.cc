 ...
 * ============================================================================
 *
 *         Author:  Fatemeh Almodaresi falmodar@cs.umd.edu, Prashant Pandey (), ppandey@cs.stonybrook.edu
 *   Organization:  University of Maryland, Stony Brook University
 *
 * ============================================================================
 */
...
int build_blockedCQF_main(BuildOpts &opt) {
    ...
    ColoredDbg<SampleObject<CQF<KeyObject> *>, KeyObject> cdbg(nqf, 2*kmer_size);
