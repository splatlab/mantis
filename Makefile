...
walkEqcls:					$(OBJDIR)/hashutil.o $(OBJDIR)/bitvector.o  ${OBJDIR}/walkEqcls.o
...
$(OBJDIR)/walkEqCls.o:	$(LOC_INCLUDE)/compressedSetBit.h $(LOC_INCLUDE)/hashutil.h $(LOC_SRC)/walkEqcls.cc
