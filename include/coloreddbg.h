...
class ColoredDbg {
	...
	private:
		...
		// color-id pairs.
		void build_abundant_color_classes(ColoredDbg<qf_obj, key_obj> &cdbg1, ColoredDbg<qf_obj, key_obj> &cdbg2);
...
template <typename qf_obj, typename key_obj>
void ColoredDbg<qf_obj, key_obj>:: assign_abundant_color_ids()
{
	auto t_start = time(nullptr);
...
template <typename qf_obj, typename key_obj>
void ColoredDbg<qf_obj, key_obj>::
	build_abundant_color_classes(ColoredDbg<qf_obj, key_obj> &cdbg1, ColoredDbg<qf_obj, key_obj> &cdbg2)
{
	...
	build_color_class_table(ColoredDbg<qf_obj, key_obj> &cdbg1, ColoredDbg<qf_obj, key_obj> &cdbg2)
{
	...
	build_abundant_color_classes(cdbg1, cdbg2);
	...
	merge(ColoredDbg<qf_obj, key_obj> &cdbg1, ColoredDbg<qf_obj, key_obj> &cdbg2)
{
	...
	sample_color_id_pairs(cdbg1, cdbg2, mantis::SAMPLE_SIZE);

	init_disk_buckets(cdbg1, cdbg2);
	uint64_t kmerCount = fill_disk_buckets(cdbg1, cdbg2);
	uint64_t colorClassCount = sampledPairs.size() + filter_disk_buckets(cdbg1, cdbg2);
